...
public class WheelView extends View {
	...
	private List<OnWheelChangedListener2> changingListeners2 = new LinkedList<OnWheelChangedListener2>();
	 ...
	 * @param listener the listener
	 */
	public void addChangingListener2(OnWheelChangedListener2 listener) {
		changingListeners2.add(listener);
	}
